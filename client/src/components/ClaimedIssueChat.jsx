...
const ClaimedIssueChat = () => {
  ...
  useEffect(() => {
    ...
    const fetchIssue = async () => {
      const res = await fetch(
        `https://furious-repair-backend.onrender.com/api/repairer/claimed/${issueId}`,
        { credentials: "include" }
      );
  ...
  useEffect(() => {
    ...
    const fetchChat = async () => {
      const res = await fetch(
        `https://furious-repair-backend.onrender.com/api/repairer/claimed/${issueId}/chat`,
        { credentials: "include" }
      );
      const data = await res.json();
      setChat(data.chat);
  ...
  const handleSend = async () => {
    if (input.trim()) {
      const res = await fetch(
        `https://furious-repair-backend.onrender.com/api/repairer/claimed/${issueId}/chat/message`,
        {
          method: "POST",
          credentials: "include",
  ...
  useEffect(() => {
    ...
    const fetchShopLocation = async () => {
      const res = await fetch(
        "https://furious-repair-backend.onrender.com/api/repairer/shop-location",
        { credentials: "include" }
      );
      const data = await res.json();
      if (data.location) {
  ...
  useEffect(() => {
    ...
    const fetchUserLocation = async () => {
      const res = await fetch(
        `https://furious-repair-backend.onrender.com/api/users/issues/${issueId}/user-location`,
        { credentials: "include" }
      );
      const data = await res.json();
      if (data.location) {
